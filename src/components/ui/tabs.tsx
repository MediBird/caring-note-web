...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Content
    ref={ref}
    className={cn(
      'mb-10 pt-6 pb-10 ring-offset-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-950 focus-visible:ring-offset-2 dark:ring-offset-neutral-950 dark:focus-visible:ring-neutral-300 overflow-y-auto mx-auto w-full max-w-[1584px] px-[92px] [&>*]:max-w-[1400px] [&>*]:mx-auto',
      className,
    )}
    {...props}
  />
