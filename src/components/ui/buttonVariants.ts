  ...
  'inline-flex items-center justify-center gap-1 whitespace-nowrap font-bold ring-offset-white transition-colors disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 ',
  {
    variants: {
      ...
      variant: {
        ...
        secondaryError:
          'bg-white border-[1.5px] border-error-50 text-error-50 hover:bg-error-10 active:bg-error-20 active:border-error-60 disabled:bg-grayscale-20 disabled:text-grayscale-40 disabled:border-grayscale-40',
        pressed:
