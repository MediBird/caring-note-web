...
import {
  useHistoryData,
  useIndependentLifeInformationHistoryQuery,
} from '../../hooks/query/useHistoryQuery';
import {
  formatCommunicationHistory,
  formatEvacuationHistory,
  formatWalkingHistory,
...
const IndependentLifeSection: React.FC<IndependentLifeSectionProps> = ({
  ...
  const {
    ...
    isInitialized: communicationInitialized,
  } = useHistoryData(
  ...
  const {
    ...
    isInitialized: walkingInitialized,
  } = useHistoryData(
  ...
  const {
    ...
    isInitialized: evacuationInitialized,
  } = useHistoryData(
          ...
          <div className="flex items-center gap-2">
            ...
            {communicationHistory && communicationHistory.length > 0 && (
              <HistoryPopover
                historyData={communicationHistory}
                isLoading={communicationLoading}
                hasData={communicationHasData && communicationInitialized}
            ...
            <div className="flex items-center gap-2">
              ...
              {walkingHistory && walkingHistory.length > 0 && (
                <HistoryPopover
                  historyData={walkingHistory}
                  isLoading={walkingLoading}
                  hasData={walkingHasData && walkingInitialized}
        ...
        <Card className="h-full p-4">
          <CardHeader className="pb-3">
            <div className="flex items-center gap-2">
              ...
              {evacuationHistory && evacuationHistory.length > 0 && (
                <HistoryPopover
                  historyData={evacuationHistory}
                  isLoading={evacuationLoading}
                  hasData={evacuationHasData && evacuationInitialized}
