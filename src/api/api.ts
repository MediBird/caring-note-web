  ...
  return {
    ...
    async selectCounselees(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<CommonResListSelectCounseleeRes>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.selectCounselees(page, size, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
...
export const DefaultApiFactory = function (
  ...
  return {
    ...
    selectCounselees(
      ...
      return localVarFp
        .selectCounselees(page, size, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
...
export const AIApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    deleteAICounselSummary: async (
      deleteAICounselSummaryReq: DeleteAICounselSummaryReq,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'deleteAICounselSummaryReq' is not null or undefined
      assertParamExists(
        'deleteAICounselSummary',
        'deleteAICounselSummaryReq',
        deleteAICounselSummaryReq,
      );
     ...
     * @throws {RequiredError}
     */
    selectAICounselSummaryPopUp: async (
      counselSessionId: string,
      baseDate?: string,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'counselSessionId' is not null or undefined
      assertParamExists(
        'selectAICounselSummaryPopUp',
        'counselSessionId',
        counselSessionId,
      );
      const localVarPath = `/v1/counsel/ai/{counselSessionId}/popup`.replace(
        `{${'counselSessionId'}}`,
        encodeURIComponent(String(counselSessionId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    selectAICounselSummaryStatus: async (
      counselSessionId: string,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'counselSessionId' is not null or undefined
      assertParamExists(
        'selectAICounselSummaryStatus',
        'counselSessionId',
        counselSessionId,
      );
      const localVarPath = `/v1/counsel/ai/{counselSessionId}/status`.replace(
        `{${'counselSessionId'}}`,
        encodeURIComponent(String(counselSessionId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    selectAnalysedText: async (
      ...
      const localVarPath = `/v1/counsel/ai/{counselSessionId}/ta`.replace(
        `{${'counselSessionId'}}`,
        encodeURIComponent(String(counselSessionId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    selectSpeakerList: async (
      ...
      const localVarPath =
        `/v1/counsel/ai/{counselSessionId}/stt/speaker/list`.replace(
          `{${'counselSessionId'}}`,
          encodeURIComponent(String(counselSessionId)),
        );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    selectSpeechToText: async (
      ...
      const localVarPath = `/v1/counsel/ai/{counselSessionId}/stt`.replace(
        `{${'counselSessionId'}}`,
        encodeURIComponent(String(counselSessionId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const AIApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async analyseText(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<SuccessRes>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.analyseText(
        analyseTextReq,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['AIApi.analyseText']?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.convertSpeechToText(
          audio,
          body,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['AIApi.convertSpeechToText']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.deleteAICounselSummary(
          deleteAICounselSummaryReq,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['AIApi.deleteAICounselSummary']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async selectAICounselSummaryPopUp(
      counselSessionId: string,
      baseDate?: string,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<CommonResSelectAICounselSummaryPopUpRes>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.selectAICounselSummaryPopUp(
          counselSessionId,
          baseDate,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['AIApi.selectAICounselSummaryPopUp']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async selectAICounselSummaryStatus(
      counselSessionId: string,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<CommonResSelectAICounselSummaryStatusRes>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.selectAICounselSummaryStatus(
          counselSessionId,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['AIApi.selectAICounselSummaryStatus']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async selectAnalysedText(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<CommonResSelectAnalysedTextRes>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.selectAnalysedText(
          counselSessionId,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['AIApi.selectAnalysedText']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async selectSpeakerList(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<CommonResListSelectSpeakerListRes>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.selectSpeakerList(
          counselSessionId,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['AIApi.selectSpeakerList']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async selectSpeechToText(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<CommonResListSelectSpeechToTextRes>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.selectSpeechToText(
          counselSessionId,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['AIApi.selectSpeechToText']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const AIApiFactory = function (
  ...
  return {
    ...
    analyseText(
      analyseTextReq: AnalyseTextReq,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<SuccessRes> {
      return localVarFp
        .analyseText(analyseTextReq, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    convertSpeechToText(
      ...
      return localVarFp
        .convertSpeechToText(audio, body, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    deleteAICounselSummary(
      ...
      return localVarFp
        .deleteAICounselSummary(deleteAICounselSummaryReq, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    selectAICounselSummaryPopUp(
      ...
      return localVarFp
        .selectAICounselSummaryPopUp(counselSessionId, baseDate, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    selectAICounselSummaryStatus(
      ...
      return localVarFp
        .selectAICounselSummaryStatus(counselSessionId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    selectAnalysedText(
      ...
      return localVarFp
        .selectAnalysedText(counselSessionId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    selectSpeakerList(
      ...
      return localVarFp
        .selectSpeakerList(counselSessionId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    selectSpeechToText(
      ...
      return localVarFp
        .selectSpeechToText(counselSessionId, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class AIApi extends BaseAPI {
   ...
   * @memberof AIApi
   */
  public selectAICounselSummaryPopUp(
    counselSessionId: string,
    baseDate?: string,
    options?: RawAxiosRequestConfig,
  ) {
   ...
   * @memberof AIApi
   */
  public selectAICounselSummaryStatus(
    counselSessionId: string,
    options?: RawAxiosRequestConfig,
  ) {
    return AIApiFp(this.configuration)
 ...
 * @export
 */
export const AICounselSummaryControllerApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
 ...
 * @export
 */
export const AICounselSummaryControllerApiFp = function (
  configuration?: Configuration,
) {
  const localVarAxiosParamCreator =
    AICounselSummaryControllerApiAxiosParamCreator(configuration);
  return {
    /**
     *
     * @summary 선택 발화자 기준 TA
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['AICounselSummaryControllerApi.analyseText']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerBasePath =
        operationServerMap[
          'AICounselSummaryControllerApi.convertSpeechToText'
        ]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      ...
      const localVarOperationServerBasePath =
        operationServerMap[
          'AICounselSummaryControllerApi.deleteAICounselSummary'
        ]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      ...
      const localVarOperationServerBasePath =
        operationServerMap[
          'AICounselSummaryControllerApi.selectAICounselSummaryPopUp'
        ]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      ...
      const localVarOperationServerBasePath =
        operationServerMap[
          'AICounselSummaryControllerApi.selectAICounselSummaryStatus'
        ]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      ...
      const localVarOperationServerBasePath =
        operationServerMap[
          'AICounselSummaryControllerApi.selectAnalysedText'
        ]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['AICounselSummaryControllerApi.selectSpeakerList']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerBasePath =
        operationServerMap[
          'AICounselSummaryControllerApi.selectSpeechToText'
        ]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
 ...
 * @export
 */
export const AICounselSummaryControllerApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
...
export class AICounselSummaryControllerApi extends BaseAPI {
  ...
  public analyseText(
    ...
    return AICounselSummaryControllerApiFp(this.configuration)
      .analyseText(analyseTextReq, options)
      .then((request) => request(this.axios, this.basePath));
  }
...
export const CounselSessionControllerApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    getSessionDatesByYearAndMonth: async (
      year: number,
      month: number,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
...
export const CounselSessionControllerApiFp = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async getSessionDatesByYearAndMonth(
      year: number,
      month: number,
      options?: RawAxiosRequestConfig,
    ): Promise<
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getSessionDatesByYearAndMonth(
          year,
          month,
          options,
        );
    ...
    async getSessionStats(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<CommonResCounselSessionStatRes>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getSessionStats(
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['CounselSessionControllerApi.getSessionStats']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const CounselSessionControllerApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    getSessionDatesByYearAndMonth(
      year: number,
      month: number,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<CommonResListLocalDate> {
      return localVarFp
        .getSessionDatesByYearAndMonth(year, month, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
...
export class CounselSessionControllerApi extends BaseAPI {
   ...
   * @memberof CounselSessionControllerApi
   */
  public getSessionDatesByYearAndMonth(
    year: number,
    month: number,
    options?: RawAxiosRequestConfig,
  ) {
...
export const CounseleeControllerApiFp = function (
  ...
  return {
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['CounseleeControllerApi.addCounselee']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['CounseleeControllerApi.deleteCounselee']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['CounseleeControllerApi.deleteCounseleeBatch']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['CounseleeControllerApi.selectCounselee']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['CounseleeControllerApi.selectCounselees']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['CounseleeControllerApi.updateCounselee']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const WasteMedicationControllerApiFp = function (
  ...
  return {
    ...
    > {
      ...
      const localVarOperationServerBasePath =
        operationServerMap[
          'WasteMedicationControllerApi.addAndUpdateWasteMedicationRecord'
        ]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
