...
export class TUSApi extends BaseAPI {
    ...
    public getUploadStatus(fileId: string, options?: RawAxiosRequestConfig) {
        return TUSApiFp(this.configuration).getUploadStatus(fileId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public uploadProcess(fileId: string, uploadOffset: number, options?: RawAxiosRequestConfig) {
        return TUSApiFp(this.configuration).uploadProcess(fileId, uploadOffset, options).then((request) => request(this.axios, this.basePath));
    }
}
