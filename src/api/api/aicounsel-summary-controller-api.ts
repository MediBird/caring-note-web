...
export const AICounselSummaryControllerApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async convertSpeechToText1(audio: File, body: ConvertSpeechToTextReq, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SuccessRes>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['AICounselSummaryControllerApi.convertSpeechToText1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
...
export class AICounselSummaryControllerApi extends BaseAPI {
    ...
    public convertSpeechToText(counselSessionId: string, options?: RawAxiosRequestConfig) {
        return AICounselSummaryControllerApiFp(this.configuration).convertSpeechToText(counselSessionId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public convertSpeechToText1(audio: File, body: ConvertSpeechToTextReq, options?: RawAxiosRequestConfig) {
        return AICounselSummaryControllerApiFp(this.configuration).convertSpeechToText1(audio, body, options).then((request) => request(this.axios, this.basePath));
    }
